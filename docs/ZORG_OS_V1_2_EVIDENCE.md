...
> **Superseded for product canon:** strategy, UX law, and terminology are governed by **Operational Constitution v2** (`docs/Carelane_Operational_Constitution_v2.md`, `docs/FOUNDATION_LOCK.md`, `docs/ZORG_OS_V1_3_STRATEGIC_REALIGNMENT_EVIDENCE.md`). Dit document blijft relevant als **technische** evidence voor de v1.2 API- en schema-uitbreidingen totdat die worden vervangen of samengevoegd.
