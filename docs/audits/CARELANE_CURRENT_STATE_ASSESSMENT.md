# Carelane — current-state assessment (runtime + page audit)
...
**Companions:** backend/architecture detail in [`../CARELANE_BACKEND_QUALITY_AUDIT_2026Q2.md`](../CARELANE_BACKEND_QUALITY_AUDIT_2026Q2.md); component detail in [`../design/CARELANE_COMPONENT_REGISTER.md`](../design/CARELANE_COMPONENT_REGISTER.md); archetypes in [`../design/CARELANE_PAGE_ARCHETYPES.md`](../design/CARELANE_PAGE_ARCHETYPES.md). Not duplicated here.
...
| `/profile/` | 200, 6.5 KB Django HTML | Genuinely server-rendered (title "Profiel - Carelane") |
