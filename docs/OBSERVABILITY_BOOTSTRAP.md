...
This document defines the minimum monitoring baseline for Carelane.
...
- API latency SLO: `p95 < 500ms` for `/static/spa/?view=dashboard`, `/care/`, `/care/<id>/`
...
- Rollback: [`docs/ROLLBACK_RUNBOOK.md`](/Users/haroonwahed/Documents/Projects/Carelane/docs/ROLLBACK_RUNBOOK.md)
- Manual smoke: [`docs/MANUAL_SMOKE_CHECKLIST.md`](/Users/haroonwahed/Documents/Projects/Carelane/docs/MANUAL_SMOKE_CHECKLIST.md)
