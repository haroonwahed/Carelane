# CareOn Page Review Checklist

## Purpose

Use this checklist when reviewing a CareOn page for visual hierarchy, operational clarity, and consistency with the CareOn design governance.
