# Carelane Demo Script and Click-Path
...
- Verified screenshot set:
  - `docs/checkpoints/screenshots/carelane-demo-fix-09-regiekamer-live.png`
  - `docs/checkpoints/screenshots/carelane-demo-fix-10-aanmeldingen-live.png`
  - `docs/checkpoints/screenshots/carelane-demo-fix-11-matching-live.png`
  - `docs/checkpoints/screenshots/carelane-demo-fix-12-matching-detail-live.png`
  - `docs/checkpoints/screenshots/carelane-demo-fix-13-reacties-live.png`
  - `docs/checkpoints/screenshots/carelane-demo-fix-14-plaatsingen-live.png`
  - `docs/checkpoints/screenshots/carelane-demo-fix-intake-provider-confirmed.png`
  - `docs/checkpoints/screenshots/carelane-demo-rehearsal-08-acties.png`

## 3. Narrative Summary

Carelane helps a municipality move a care request from registration to matching, provider response, placement and intake while keeping every next action clear.
...
- How does Carelane decide matches?
