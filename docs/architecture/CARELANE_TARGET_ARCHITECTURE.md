# Carelane — target architecture

**Status:** Proposed — **read-only**. No production code changed.
**Date:** 2026-06-17
**Scope:** Consolidates the desired end-state across backend, frontend, and the SPA/Django boundary. Extends (does not duplicate) the backend detail in [`../CARELANE_BACKEND_QUALITY_AUDIT_2026Q2.md`](../CARELANE_BACKEND_QUALITY_AUDIT_2026Q2.md) and the `views.py` ADR.
