...
Pilot/staging origin documented for smoke checks: **`https://carelane-web.onrender.com`**. For production verification, substitute your production origin (same path checks).
