# CareOn Design Language — v1 (Calm Operational)

> The single source of truth for how CareOn looks and feels. Derived from the
...
`CAREON_UI_CONTRACT.md` (now retired).

---

## 1. The one idea

**Calm operational.** CareOn is used all day by coordinators making high-stakes
...
7. Delete `CAREON_UI_CONTRACT.md` and `legacyVisualContract` once callsites move.
