# Carelane UI Contract

> **⚠️ SUPERSEDED — 2026-06-15**
>
> This document is retired. The values below are **stale** and conflict with the live token system.
>
> **Authoritative source:** [`CARELANE_DESIGN_SYSTEM_V1.md`](./CARELANE_DESIGN_SYSTEM_V1.md) and `client/src/styles/globals.css` (`--care-*` namespace).
>
...
~~This document is the hard visual contract for Carelane UI surfaces.
...
- Applies to authenticated Carelane application pages.
...
- [Carelane Operational Constitution v2](../Carelane_Operational_Constitution_v2.md)
