# Carelane Operational Constitution v2

Plain-text export of [`Carelane_Operational_Constitution_v2.docx`](./Carelane_Operational_Constitution_v2.docx) for diffs and search. **Authoritative formatting and sign-off:** the Word document. **Persisted workflow states, API `phase` keys, mutation endpoints, and decision-engine rules:** [`FOUNDATION_LOCK.md`](./FOUNDATION_LOCK.md).

---

**Status**

Authoritative operational doctrine for the Carelane platform.

**Supersedes:**
	•	Zorg_OS_Product_System_Core_v1_3
	•	Zorg_OS_Technical_Foundation_v1_3
	•	Carelane Design Constitution V1

1. Core Positioning
Carelane is not a generic SaaS platform.
Carelane is a regulated operational coordination layer for care allocation under scarcity.
...
2.1 Regie First
Carelane is a regielaag across municipalities, providers, coordinators and placement actors.
...
Carelane assumes scarcity is real.
...
The concrete shell, spacing, surface, radius, and CTA values are pinned in [`docs/design/CARELANE_UI_CONTRACT.md`](design/CARELANE_UI_CONTRACT.md) and mirrored in `client/src/design/tokens.ts`.
