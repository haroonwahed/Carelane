...
> ✅ = geïmplementeerd en tests groen. Backend: 963 passed. Frontend: 226 passed. tsc: 0 errors.
...
- **Bestanden:** `client/src/components/care/SystemAwarenessPage.tsx`.
...
## Aanbevolen uitvoervolgorde (resterende items)
1. **P1-5** (Regiekamer één CTA — laatste P1 UX-slice)
2. **P2-6 / P2-7** (rapportages + footprint-opruiming)
3. **P3-2** (JSON document-upload API)
4. **P3-4** (seed-reset org-isolatie)
5. **P3-3 / P3-5 / P3-6** (planning, state-deduplicatie, gebruikersbeheer)

## Voltooide items (samenvatting)
- P0-1 ✅ P1-1 ✅ P1-2 ✅ P1-3 ✅ P1-4 ✅
- P2-3 ✅ P2-4 ✅ P2-5 ✅ P2-8 ✅ P2-9 ✅
- P3-1 ✅
