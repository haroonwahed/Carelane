...
- **Acceptatiecriteria:** alleen het canonieke `visualContract`-palet blijft; consumers gemigreerd; geen visuele regressie t.o.v. `CARELANE_UI_CONTRACT.md`.
...
### ✅ P2-8 · `CARELANE_PILOT_SPA_ONLY=True` afdwingen  (R7)
...
- **Geïmplementeerd 2026-06-14.** `CARELANE_MAX_DOCUMENT_UPLOAD_MB` (default 20 MB) gevalideerd in `intake_create_api` vóór form-processing; retourneert 413 met NL-foutmelding. 2 tests.
