# Carelane Demo Route Readiness Map
...
- Source inputs: `AGENTS.md`, `docs/checkpoints/carelane-operational-ui-stabilization.md`, `docs/design/CARELANE_UI_CONTRACT.md`, `docs/Carelane_Operational_Constitution_v2.md`, `client/src/lib/routes.ts`, `client/src/components/examples/MultiTenantDemo.tsx`, `client/src/components/navigation/Sidebar.tsx`.
