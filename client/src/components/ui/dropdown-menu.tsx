  ...
  return (
    <DropdownMenuPrimitive.SubContent
      data-slot="dropdown-menu-sub-content"
        className={cn(
        "bg-popover text-popover-foreground data-[state=open]:animate-subtle-in data-[state=closed]:animate-subtle-out z-50 min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-[var(--care-radius-card)] border border-border/80 p-1 shadow-xl backdrop-blur-none shadow-[var(--care-shadow-card)] dark:border-primary/20",
        className,
      )}
      {...props}
    />
