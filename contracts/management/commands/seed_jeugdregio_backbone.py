...
PROVINCE_DEFAULT_JEUGDREGIO = {
    ...
    'Gelderland': 'Centraal Gelderland',
    'Overijssel': 'West-Overijssel',
    'Flevoland': 'Flevoland',
    'Drenthe': 'Drenthe',
    'Friesland': 'Friesland',
    'Groningen': 'Groningen',
...
MUNICIPALITY_JEUGDREGIO_OVERRIDES = {
    ...
    'Heemstede': 'Kennemerland',
    'Bloemendaal': 'Kennemerland',
    'Zandvoort': 'Kennemerland',
    'Alkmaar': 'Alkmaar',
    'Bergen (NH)': 'Alkmaar',
    'Castricum': 'Alkmaar',
    'Dijk en Waard': 'Alkmaar',
    'Heiloo': 'Alkmaar',
    'Uitgeest': 'Alkmaar',
    'Den Helder': 'Kop van Noord-Holland',
    'Hollands Kroon': 'Kop van Noord-Holland',
    'Schagen': 'Kop van Noord-Holland',
    'Texel': 'Kop van Noord-Holland',
    'Hoorn': 'Westfriesland',
    'Drechterland': 'Westfriesland',
    'Enkhuizen': 'Westfriesland',
    'Koggenland': 'Westfriesland',
    'Medemblik': 'Westfriesland',
    'Opmeer': 'Westfriesland',
    'Stede Broec': 'Westfriesland',
    'Gooise Meren': 'Gooi en Vechtstreek',
    'Hilversum': 'Gooi en Vechtstreek',
    'Huizen': 'Gooi en Vechtstreek',
    'Laren': 'Gooi en Vechtstreek',
    'Blaricum': 'Gooi en Vechtstreek',
    'Wijdemeren': 'Gooi en Vechtstreek',
    ...
    'Rozendaal': 'Arnhem',
    'Renkum': 'Arnhem',
    'Duiven': 'Centraal Gelderland',
    'Westervoort': 'Centraal Gelderland',
    'Zevenaar': 'Centraal Gelderland',
    'Lingewaard': 'Centraal Gelderland',
    'Montferland': 'Centraal Gelderland',
    'Doesburg': 'Centraal Gelderland',
    'Brummen': 'Centraal Gelderland',
    'Voorst': 'Centraal Gelderland',
    'Nijmegen': 'Rijk van Nijmegen',
    'Beuningen': 'Rijk van Nijmegen',
    'Berg en Dal': 'Rijk van Nijmegen',
    'Heumen': 'Rijk van Nijmegen',
    'Wijchen': 'Rijk van Nijmegen',
    'Mook en Middelaar': 'Rijk van Nijmegen',
    ...
    'Zwolle': 'West-Overijssel',
    'Kampen': 'West-Overijssel',
    'Dalfsen': 'West-Overijssel',
    'Hardenberg': 'West-Overijssel',
    'Steenwijkerland': 'West-Overijssel',
    'Staphorst': 'West-Overijssel',
    'Zwartewaterland': 'West-Overijssel',
    'Olst-Wijhe': 'West-Overijssel',
    'Raalte': 'West-Overijssel',
    'Ommen': 'West-Overijssel',
    'Helmond': 'Helmond-De Peel',
    'Deurne': 'Helmond-De Peel',
    'Asten': 'Helmond-De Peel',
    'Gemert-Bakel': 'Helmond-De Peel',
    'Laarbeek': 'Helmond-De Peel',
...
class Command(BaseCommand):
    ...
    def _seed_for_org(self, organization: Organization, regios: list[RegioRow], gemeenten: list[GemeenteRow]) -> None:
        ...
        for row in gemeenten:
            key = _resolve_jeugdregio(row.naam, row.provincie).lower()
            if key not in regions_by_name:
                raise CommandError(
                    f"Gemeente '{row.naam}' verwijst naar onbekende regio '{key}'. Voeg regio eerst toe aan regios CSV."
                )
