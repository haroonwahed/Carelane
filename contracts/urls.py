...
urlpatterns = [
    ...
    path('api/members/', api_views.members_api, name='members_api'),
    path('api/members/<int:membership_id>/role/', api_views.member_role_api, name='member_role_api'),
    path('api/members/<int:membership_id>/activation/', api_views.member_deactivate_api, name='member_deactivate_api'),
    path('api/invitations/<int:invitation_id>/action/', api_views.invitation_action_api, name='invitation_action_api'),
